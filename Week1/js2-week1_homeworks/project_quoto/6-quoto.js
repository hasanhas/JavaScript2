...
const doubleParts = document.createElement('div');
doubleParts.className = 'doubleParts';
let h1 = document.createElement('h1');
doubleParts.appendChild(h1);
let h3 = document.createElement('h3');
doubleParts.appendChild(h3);
document.body.appendChild(doubleParts);

const divButton = document.createElement('div');
divButton.className = 'doubleParts';
divButton.id = 'div2'; //normally we did styling with doubleParts class but now we need addition properties for more styling
